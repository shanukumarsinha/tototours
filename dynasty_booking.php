...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Beijing 10/8?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra Night Shanghai 10/20?:- </span>  
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>DYNASTY</span> Classic China</h2>
            <p class="font-4" style="color: #fff;">October 8-20, 2017 - RESERVATION FORM</p>
          </div>
          ...
          <div class="tours-container">
            ...
            <?php } ?>
              ...
              <div class="tours-search mb-20 col-sm-12">
                ...
                <div class="tours-calendar divider-skew"> 
                  <input placeholder="Birthdate:" type="text" name="birthdate" id="birthdate" onfocus="(this.type='date')" onblur="(this.type='text')" class="calendar-default textbox-n"><i class="flaticon-suntour-calendar calendar-icon"></i>
                </div>
              </div>
             <div method="post" class="form contact-form alt clearfix" novalidate="novalidate">
              <div class="">
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12">
                  ...
                  <label for="subscribe2">I have read the Refund Policy and agree to the terms and conditions within this document. (see below)</label>
              </div>
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/chinaform2017.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/chinaform2017.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
             ...
             <p class="col-sm-12"><strong>Please read this completely and then acknowledge that you have read and understood this information on your
              ...
              <p class="col-sm-12">All Tours (Domestic and International): $300.00 of your deposit is non-refundable. Final payment is normally due 80 days prior to
