...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Manila 1/14?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Manila 1/27?:- </span>  
...
$subject="PHILIPPINE ISLANDS BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>PEARLS OF THE ORIENT</span>  The Philippine Islands</h2>
            <p class="font-4" style="color: #fff;">January 14 - 27, 2018 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Manila 1/14?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Manila 1/27?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-sm-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/philippinesform2018-1.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/philippinesform2018-1.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
