...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Montreal on 12/19?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Quebec City on 12/26? </span>  
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_shanghai'].'</span><br><br>'; 

    //$message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Mumbai Extension?:-</span>
    //               <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['karnataka_extension'].'</span><br><br>';

    //$message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">EXTEND Mumbai trident hotel to 11/1AM?:-</span>
    //               <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_karnataka_trident'].'</span><br><br>';
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>JOYEAUX NOEL</span>  French Canadian Christmas</h2>
            <p class="font-4" style="color: #fff;">December 20 – 26, 2018</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night Montreal on 12/19?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night Quebec City on 12/26? </h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                  ...
                  <!--<div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head"> Mumbai Extension? </h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="karnataka_extension" id="karnataka_extension">
                           <option>No</option>
                           <option>Yes</option>
                          </select>
                        </div>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extend Mumabi Trident hotel to 11/1am?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="extra_karnataka_trident" id="extra_karnataka_trident">
                           <option>No</option>
                           <option>Yes</option>
                          </select>
                        </div>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12">
                  <input type="checkbox" id="subscribe1" name="subscribe1" value="Checked">
              ...
              <div class="col-md-12">
                  <input type="checkbox" id="subscribe2" name="subscribe2" value="Checked">
              ...
              <div class="col-md-12">
                  <input type="checkbox" id="subscribe3" name="subscribe3" value="Checked">
                  <label for="subscribe3">I authorize Toto Tours to use photos of me from this tour in their promotional materials.</label>
              </div>

              <div class="col-md-12">
                  <input type="checkbox" id="subscribe4" name="subscribe4" value="Checked">
              ...
              <div class="col-md-12">
                  <input type="checkbox" id="subscribe6" name="subscribe6" value="Checked">
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('pdf/canadian_christmas_booking.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="pdf/canadian_christmas_booking.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
