...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message	.=	'<span style="color:#ffc107; font-size:13px; font-weight:bold;">Accommodations:-</span>
     ...
     $message  =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Naplees 8/31?:-</span>    
                    <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>';                

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Naples 9/9?:- </span>  
    ...
    $message	.=	'<span style="color:#ffc107; font-size:13px; font-weight:bold;">Full Name Passport:-<span> 		
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['full_name_passport'].'</span><br><br>';
...
$subject="BRAVA ITALIA: NAPLES / AMALFI / CAPRI";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>BRAVA ITALIA: </span> NAPLES / AMALFI / CAPRI</h2>
            <p class="font-4" style="color: #fff;">August 31 - September 9, 2018 - RESERVATION FORM</p>
          </div>
      ...
      <section>
        <div class="search-hotels mb-40">
          <div class="tours-container">
            <div class="tours-box">
            <p class="col-sm-12"><strong>This is an interactive form. You can type directly in the spaces provided and there are pulldown menus for your
            ...
            the appropriate selection for drop-down boxes within the form. A deposit of $600 is required to hold your reservation. You may
            pay using your Visa, MasterCard, Discover, or American Express account or send us a personal check. Be careful not to leave
            this screen until your form is printed. Your browser will not retain this information. You may save a file for your records by clicking
            “file-save as” in your browser’s menu. Do not email your saved file to us or anyone else. You can mail this completed form
            to Toto Tours, Ltd., 1326 West Albion Avenue, Chicago, IL 60626-4753 or fax it (credit card payment only) to 773-274-8695.
            Reservations cannot be accepted without your physical signature on this form.</p>
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Accommodations?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          ...
                          <option>DSU Room</option>
                          </select>
                        </div>
                  </div>
				
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Naplees 8/31?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Naples 9/9?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-sm-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/italiaresform.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/italiaresform.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
             ...
             <p class="col-sm-12"><strong>Please read this completely and then acknowledge that you have read and understood this information on your
              ...
              directors, shareholders, employees, staff, agents, contractors, and assigns from any and all claims, causes of action, lawsuits, counterclaims, cross claims, and third paty claims whatsoever, whether present, future, or unanticipated, resulting from
