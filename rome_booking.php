...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night 12/21?:-</span>    
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>CHRISTMAS IN THE ETERNAL CITY</span>  Roman Holiday</h2>
            <p class="font-4" style="color: #fff;">December 21-28, 2017 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night 12/21?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra Night 12/28?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
