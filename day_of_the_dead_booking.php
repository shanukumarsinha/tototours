...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night San Miguel de Allende 10/23?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Morelia 11/3?:- </span>  
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_shanghai'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Optional Cervantino Festival?:- </span>  
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['Optional_cervantino_festival'].'</span><br><br>'; 
...
$subject="DAY OF THE DEAD BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>Day of the Dead</span>  Sensational Mexico</h2>
            <p class="font-4" style="color: #fff;">October 24 – November 3, 2018</p>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night San Miguel de Allende 10/23?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night Morelia 11/3?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head"> Optional Cervantino Festival? </h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="Optional_cervantino_festival" id="Optional_cervantino_festival">
                           <option>No</option>
                           <option>Yes</option>
                          </select>
                        </div>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/day_of_the_dead_booking.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/day_of_the_dead_booking.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
