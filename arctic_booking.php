...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Montreal August 17?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    //$message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra Night 12/28?:- </span>  
    ...
    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Cabin Category:-</span>   
...
$to="shanukumarsinha@gmail.com";    
$subject="ARCTIC CRUISE BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>NORTHWEST PASSAGE</span> Arctic Cruise</h2>
            <p class="font-4" style="color: #fff;">Aug. 18 - Sept. 10, 2018 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night Montreal August 17?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Cabin Category</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="final_payment_by" id="final_payment_by">
                           <option>1- Classic</option>
                           <option>2- Deluxe</option>
                           <option>3- Premie</option>
                          </select>
                        </div>
                  </div>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-2"><strong>Total Deposit Due:   $2,500  </strong></div>
              <div class="col-md-6">
                  <div class="input-container">
              ...
              <div class="col-md-2">
                  <div class="input-container">
                    <input placeholder="Expires" name="expiry" id="expiry" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="calendar-default textbox-n">
                  </div>
              </div>
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/arcticform2018.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/arcticform2018.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
              ...
              For this special Arctic tour, $500.00 of your deposit is non-refundable. Final payment for this tour is due 150 days prior to
              departure. If you cancel after the final payment deadline, the following schedule applies:<br><br>
              150 days or more prior to departure &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$500 is non-refundable<br>
              120-149 days prior to departure &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$750 is non-refundable<br>
              119-90 days prior to departure &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;20% of the program cost is non-refundable<br>
              89-60 days prior to departure &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;50% of the program cost is non-refundable<br>
              59 days or less prior to departure &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;100% of the program cost is non-refundable<br><br>
              Please note, these refund policies are unique to this tour due to special circumstances relating to this tour. The final payment
              deadline is specified on the invoice you will receive after booking this tour.
              </p>
              <div class="clearfix"></div>
            </div>
          </div>
