...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night Kampala 3/26?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Rwanda Extension?:- </span>  
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>GORILLAS IN THE MIST</span> Uganda with Rwanda Extension</h2>
            <p class="font-4" style="color: #fff;">March 25 - April 11 (or 16), 2018 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night Kampala 3/26?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Rwanda Extension?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="extra_night_shanghai" id="extra_night_shanghai">
                           <option>No</option>
                           <option>Yes (+$1,500 additional deposit)</option>
                          </select>
                        </div>
                  </div>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-4"><strong>Total Deposit Due: </strong> <br>$1,500 (Uganda)  </br> $1,500 (Rwanda)</div>
              <div class="col-md-4">
                  <div class="input-container">
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/ugandaform2018.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/ugandaform2018.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
              ...
              Uganda Policy: (Domestic and International): $1,200.00 of your deposit is non-refundable. Final payment is normally due 80 days
              prior to departure. An earlier final payment is required for some destinations due to special circumstances relating to the tour.
              The final payment deadline is specified in the “Reservations” section of each detailed itinerary, and can also be found at the
              bottom of the invoice you will receive after booking a tour. If you cancel after the final payment deadline, the following schedule
              applies:<br><br>
