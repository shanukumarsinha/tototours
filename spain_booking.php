...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Madrid 4/16?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Santiago 4/28?:- </span>  
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>WALK THIS WAY</span> Camino de Santiago, Spain</h2>
            <p class="font-4" style="color: #fff;">April 16 - 28, 2018 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Madrid 4/16?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Santiago 4/28?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
             ...
             <div method="post" class="form contact-form alt clearfix" novalidate="novalidate">
              <div class="">
                ...
                <div class="col-md-6">
                  <div class="col-md-6">
                    <div class="input-container">
                    <input type="text" name="state" id="state" size="40" placeholder="State:" aria-required="true" class="form-row form-row-last">
                  </div>
                  </div>
                  <div class="col-md-6">
                    <div class="input-container">
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/spainform2018.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/spainform2018.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
