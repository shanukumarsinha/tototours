...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra Night Thessa. 5/15?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Athens Extension?:- </span>  
...
$subject="AMAZING THRACE NORTHERN GREECE BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>AMAZING THRACE</span> Northern Greece</h2>
            <p class="font-4" style="color: #fff;">May 15 - 25 (or 29), 2018 - RESERVATION FORM</p>
          </div>
      ...
      <section>
        <div class="search-hotels mb-40">
          <div class="tours-container">
            <div class="tours-box">
            <p><strong>This is an interactive form. You can type directly in the spaces provided and there are pulldown menus for your
            convenience throughout the form.</strong> Fill out the form below completely, print, sign, and mail it to Toto Tours. Be sure to make
            the appropriate selection for drop-down boxes within the form. A deposit of $600 (main tour or with extension) is required to
            hold your reservation. You may pay using your Visa, MasterCard, Discover, or American Express account or send us a personal
            check. Be careful not to leave this screen until your form is printed. Your browser will not retain this information. You may save
            a file for your records by clicking “file-save as” in your browser’s menu. Do not email your saved file to us or anyone else. You
            can mail this completed form to Toto Tours, Ltd., 1326 West Albion Avenue, Chicago, IL 60626-4753 or fax it (credit card
            payment only) to 773-274-8695.</p>
            ...
            <?php } ?>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra Night Thessa. 5/15?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Athens Extension?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
             ...
             <div method="post" class="form contact-form alt clearfix" novalidate="novalidate">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                  <h6 class="title-section-top font-4 form_head">Best Phone Number:</h6>
                      ...
                      <input type="text" name="email" value="" size="40" placeholder="Preferred Phone Number:" aria-required="true" class="form-row form-row-last">
                  </div>
              ...
              <!--<h6 class="title-section-top font-4 form_head">HEALTH AND DIET</h6>-->
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <p><strong>Payment Type: (Personal Check/Visa/MasterCard/Discover/American Express)</strong></p>
              ...
              <div class="col-md-2">
                  <div class="input-container">
                    <input placeholder="Date:" name="expiry" id="expiry" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="calendar-default textbox-n">
                  </div>
              </div>
              ...
              <p>Toto Tours, Ltd., 1326 West Albion Avenue, Chicago, IL 60626-4753</p>
              <p><strong>My signature below authorizes or acknowledges the following:</strong></p>
              ...
              <div class="col-md-12">
                  ...
                  <label for="subscribe1">I have read the Liability Waiver and agree to the terms and conditions within this document. (scoll down to page 2)</label>
              </div>

              <div class="col-md-12">
                  <input type="checkbox" id="subscribe2" name="subscribe2" value="newsletter">
                  <label for="subscribe2">I have read the Refund Policy and agree to the terms and conditions within this document. (scroll down to page 3)</label>
              </div>
              ...
              <div class="col-md-12">
                  ...
                  <label for="subscribe4">Travel Insurance: I acknowledge that Toto Tours has offered insurance to protect me in the event that I must cancel my
participation in the tour before departure, or become ill while the tour is in progress. Please choose one:</label>
              </div>
              ...
              <div class="col-md-12" style="padding-left: 0; padding-right: 0">
                  ...
                  <label for="subscribe6">I understand that checking this box constitutes a legal signature confirming that I acknowledge and agree to the terms described herein, and warrant the truthfulness of the information provided in this document.</label>
              </div>

              <div class="col-md-12 text-right">
                <div class="col-md-4"></div>
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/greeceform2018.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/greeceform2018.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
              ...
              <h6 class="title-section-top font-4 form_head">WAIVER OF LIABILITY</h6>

             <p><strong>Please read this completely and then acknowledge that you have read and understood this information on your
              reservation form. Your reservation form will not be accepted without acknowledging this information.</strong><br><br>

              Your signature on the completed Reservation Form will signify your agreement to the terms stipulated below. Please print this
...
remainder of this Agreement shall continue to be valid, enforceable, and in full force and effect.<br><br>
              Your signature on the completed Reservation Form will signify your agreement to the terms stipulated below. Please print
this page and save it for your records. All notifications of cancellation must be received in writing. On the date your
cancellation is received, the following penalties will apply:<br><br>
Refund Policy: $300.00 of your deposit is non-refundable. Final payment is due 80 days prior to departure. An earlier final
payment is required for some destinations due to special circumstances relating to the tour. The final payment deadline is
specified in the “Reservations” section of each detailed itinerary, and can also be found at the bottom of the invoice you will
receive after booking a tour. If you cancel after the final payment deadline, the following schedule applies:<br><br>
