...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in prague 7/20?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">Extra night in Berlin 7/29?:- </span>  
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>PARADE -</span> Prague/Dresden/Berlin Pride</h2>
            <p class="font-4" style="color: #fff;">July 20 - 29, 2018X - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in prague 7/20?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">Extra night in Berlin 7/29?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/parade-form.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/parade-form.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
