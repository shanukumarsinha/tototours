...
$subject="SUMAKHA THE JOYS OF INDIA BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>SUMAKHA</span>    The Joys of India</h2>
            <p class="font-4" style="color: #fff;">February 17 - March 4, 2018 -  RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">&nbsp;</h6>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/romeform2017.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/romeform2017.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
