...
if(isset($_REQUEST) && $_REQUEST['submit'] == "submit"){
    ...
    $message   =   '<span style="color:#ffc107; font-size:13px; font-weight:bold;">EXTRA NIGHT MUMBAI 11/5?:-</span>    
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_bejing'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">EXTRA NIGHT IN NEW DELHI 2/17?:- </span>  
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['extra_night_shanghai'].'</span><br><br>'; 

    $message  .=  '<span style="color:#ffc107; font-size:13px; font-weight:bold;">OPTIONAL DELHI EXTENSION 11/18?:-</span>   
                   <span style="color:red;font-size:13px; font-weight:bold;">'.$_REQUEST['optional_delhi_extension'].'</span><br><br>';
...
$subject="JUNGLE BOOK WILDLIFE OF INDIA BOOKING";
//$from=$email;
...
<html>
  ...
  <body>
    ...
    <section style="background-image:url('img/bg/bg-header.jpg');" class="breadcrumbs">
        <div class="container">
            <h2><span>JUNGLE BOOK</span> Wildlife of India</h2>
            <p class="font-4" style="color: #fff;">November 5-17, 2017 - RESERVATION FORM</p>
          </div>
            ...
            <?php } ?>
              ...
              <div class="">
                ...
                <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">EXTRA NIGHT MUMBAI 11/5?</h6>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">EXTRA NIGHT IN NEW DELHI 2/17?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                  ...
                  <div class="col-md-6 mb-20">
                  <h6 class="title-section-top font-4 form_head">OPTIONAL DELHI EXTENSION 11/18?</h6>
                        <div class="selection-box divider-skew"><i class="flaticon-suntour- box-icon"></i>
                          <select name="optional_delhi_extension" id="optional_delhi_extension">
                           <option>No</option>
                           <option>Yes</option>
                          </select>
                        </div>
...
to accomodate your needs, and to do so we need this information before the tour begins:
              ...
              <div class="col-md-12 text-right">
                ...
                <div class="col-md-2">
                  <span><a href="#" onclick="printJS('book-pdf/india2017.pdf', 'pdf');return false;"><img src="img/print.jpg"></a></span>
                  <span><a href="book-pdf/india2017.pdf" target="_blank"><img src="img/pdf.png"></a></span>
                </div>
